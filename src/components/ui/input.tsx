...
/**
 * Text input (PRD 4. fejezet – Űrlapok, Hozzáférhetőség).
 *
 * A 44px+ touch target keeps it usable on the driver's phone; focus-visible
 * rings satisfy the keyboard-navigation requirement (WCAG AA).
 */
